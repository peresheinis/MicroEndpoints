...
/// <summary>
/// This is a custom attribute that inherits from the built-in Attribute class in .NET 
/// and implements the IHttpMethodAttribute interface. It defines a constructor that
/// takes a single string parameter, which is used to set the value of the Template property.
/// 
/// The ConfigureEndpoint method is used to configure a web application’s endpoint with the specified
/// template and request delegate. The app.MapDelete method is called, passing in the Template
/// string and the requestDelegate delegate. This allows the user to specify a template for 
/// a delete request, which can be used to route requests to a specific handler method or controller action.
/// </summary>
public class DeleteAttribute : Attribute, IHttpMethodAttribute
{
    ...
    /// application and sets up the routing for the delete request. 
    ...
    {
        // This line of code uses the MapDelete method defined
        // in the WebApplication class to register the template
        // specified in the Template property for a DELETE HTTP method.
