...
/// template for POST requests. The constructor for this class accepts a single string 
/// argument and assigns it to the Template property. Finally, the ConfigureEndpoint method maps 
/// the Template URL to a specific request handling method by using the app.MapPost method defined
...
public class PostAttribute : Attribute, IHttpMethodAttribute
{
    ...
    /// application and sets up the routing for the post request. 
    ...
    {
        // This line of code uses the MapPost method defined
        // in the WebApplication class to register the template
        // specified in the Template property for a POST HTTP method.
